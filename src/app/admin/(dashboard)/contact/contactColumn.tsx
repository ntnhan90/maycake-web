...
//types
import { ContactResType } from "@/models/contactModel";
import DasherTippy from "@/components/common/DashTippy";
import Checkbox from "@/components/table/Checkbox";

export const contactColumns: ColumnDef<ContactResType>[] =[
    {
        id: "select",
        header:({table}) =>{
            return(
	...
	},
    {
		...
		header: "Status",
        cell:({cell}) =>{
            const value = cell.getValue() as "read" | "unread";
            ...
            return (
                <Fragment>
                    ...
                    <DasherTippy content="Edit">
                        <Button href={`/admin/contact/${id}`} variant="ghost btn-icon"
							size="sm" className="rounded-circle"
                        > 
                            <IconEdit size={16} />
                        </Button>
