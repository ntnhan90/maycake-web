...
import { faqsColumns } from "./faqsColumn"
import { useState, useEffect } from "react"
import faqApiRequest from "@/apiRequests/faqApi";
import { FaqsListResType } from "@/models/faqModel";
...
export default function FaqsTable(){
    ...
    const [data, setData] = useState<FaqsListResType | null>(null);
    ...
    const fetchFaqs = async () => {
        ...
        try{
            const res = await faqApiRequest.list(query)
            setData(res.payload);
        }finally{
            setLoading(false)
        }
