...
export default function EcomCollectionPage() {
    return (
        <Container>
            <div className="row mb-5">
                <div className="col">
                    <div className="d-md-flex justify-content-between align-items-center mb-8 w-100">
                        ...
                        <div>
                            <Link role="button"  href="/admin/ecommerce/product-collections/create" className=" d-md-flex align-items-center gap-2 btn btn-dark">
                                Create
                            </Link>
                        </div>
                    </div>
