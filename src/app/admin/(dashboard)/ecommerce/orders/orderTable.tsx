...
import { OrderResType, OrderListResType } from "@/models/product/orderModel"
...
export default function OrderTable(){
    ...
    const [data, setData] = useState<OrderListResType | null>(null);
    ...
    const fetchOrders = async () => {
        ...
        try{
            const res = await orderApiRequest.list(query)
            setData(res.payload);
        }finally{
            setLoading(false)
        }
