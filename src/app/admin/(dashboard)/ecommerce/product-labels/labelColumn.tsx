...
import { ProLabelResType } from "@/models/product/labelsModel";

export const labelColumns: ColumnDef<ProLabelResType>[] = [
    {
        id : "select",
        header: ({table}) =>{
            return(
            ...
            return(
                <Fragment>
                    ...
                    <DasherTippy content="Edit">
                        <Button href={`/admin/ecommerce/product-labels/${id}`} variant="ghost btn-icon"
							size="sm" className="rounded-circle"
                        > 
                            <IconEdit size={16} />
                        </Button>
