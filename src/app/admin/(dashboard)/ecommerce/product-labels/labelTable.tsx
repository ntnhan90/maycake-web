...
import { useGetProductLabelListQuery } from "@/queries/useProductLabel"
import { labelColumns } from "./labelColumn"

export default function ProductLabelTable(){
    const labelListQuery = useGetProductLabelListQuery();
    const data = labelListQuery.data?.payload.data ?? [];
    return (
        <div className="row">
            <div className="col">
                <Card>
