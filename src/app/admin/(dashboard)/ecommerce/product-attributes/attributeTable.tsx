...
import { attributeColumns } from "./attributeColumn"
import { useState, useEffect } from "react"
import attributeApiRequest from "@/apiRequests/product/attributeApi";
import { AttributeListResType } from "@/models/product/attributeModel";
...
export default function AttributeTable(){
    ...
    const [data, setData] = useState<AttributeListResType | null>(null);
    ...
    const fetchAttributes = async () => {
        ...
        try{
            const res = await attributeApiRequest.list(query)
            setData(res.payload);
        }finally{
            setLoading(false)
        }
