...
import { DiscountColumns } from "./discountColumn"
import { useState, useEffect } from "react"
import discountApiRequest from "@/apiRequests/discountApi";
import { DiscountListResType } from "@/models/product/discountModel";
...
export default function DiscountTable(){
    ...
    const [data, setData] = useState<DiscountListResType | null>(null);
    ...
    const fetchDiscounts = async () => {
        ...
        try{
            const res = await discountApiRequest.list(query)
            setData(res.payload);
        }finally{
            setLoading(false)
        }
