import { DiscountResType } from "@/models/product/discountModel";
...
export const DiscountColumns: ColumnDef<DiscountResType>[] = [
    {
        id : "select",
        header: ({table}) =>{
            return(
            ...
            return(
                <Fragment>
                    ...
                    <DasherTippy content="Edit">
                        <Button href={`/admin/ecommerce/discounts/${id}`} variant="ghost btn-icon"
							size="sm" className="rounded-circle"
                        > 
                            <IconEdit size={16} />
                        </Button>
